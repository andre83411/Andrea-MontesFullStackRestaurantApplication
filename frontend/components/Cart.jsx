...
export default function Cart() {
  ...
  return (
    <Draggable>
    <section className="relative right-20 top-[242px]">
      <div className="relative">
        <button
          onClick={() => setShowCart((prevState) => !prevState)}
          className="absolute right-0 z-10 bg-cyan-600 text-white p-3 rounded-full hover:bg-yellow-500 items-center"
        >
          <svg
            width="24"
            height="24"
        ...
        {showCart && (
          <div className="absolute right-0 max-h-screen overflow-y-auto">
              ...
              <div className="max-w-lg pt-6 pb-8 px-8 mx-auto">
                ...
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="inline-block w-full px-6 py-3 text-center font-bold text-white bg-teal-400 hover:bg-emerald-500 transition duration-200 rounded-full"
                  >
